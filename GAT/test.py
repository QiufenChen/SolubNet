...
def get_matrics(y_pred, y_true):
    ...
    print("%15.4f %15.4f %15.4f " % (mae, mse, rmse))
    print(separator)
...
if __name__ == '__main__':
    ...
    # data_fn = 'external_data/' + 'boobier' + '.csv'
    # data_fn = 'external_data/' + 'delaney' + '.csv'
    ...
    for i, gx in enumerate(data):
        ...
        pred_prop = round(th.mean(solubNet(gx[1]), dim=0).item(), 4)
    ...
    test.to_csv('test_result/Solub.csv', encoding='utf-8')
