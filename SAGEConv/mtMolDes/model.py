...
from dgl.nn.pytorch import GraphConv, TAGConv, ChebConv, GATConv, SAGEConv
...
class GCNNet(nn.Module):
    ...
    def __init__(self, num_features, num_labels, features_str):
        ...
        self.gcn_layers.append(SAGEConv(num_features, num_hiddens, activation=nn.ReLU(), aggregator_type="mean"))
        self.gcn_layers.append(SAGEConv(num_hiddens, num_hiddens, activation=nn.ReLU(), aggregator_type="mean"))
        self.gcn_layers.append(SAGEConv(num_hiddens, num_labels, aggregator_type="mean"))
