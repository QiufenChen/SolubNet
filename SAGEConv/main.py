...
print("# of all graphs/labels:      %d" % (len(data_train)+len(data_test)))
...
# df_valid.to_csv('dataset/DelaneyValid.csv', index=False)
df_test.to_csv('dataset/DelaneyTest.csv', index=False)
